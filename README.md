...
<h1>Designing an Automatic Data Collection and Storage System with AWS Lambda and Slack Integration for Server Availability Monitoring and Slack Notification.<br/></h1>

**Problem Statement:** <br/> The task is to create an AWS Lambda function that periodically fetches data from an API and stores it in an Amazon RDS instance. The function should be triggered by an Amazon CloudWatch Event every 15 seconds, and an alert should be sent to a Slack channel if the server goes down.
<br/>

**Technologies Used:** <br/> AWS Lambda, Amazon RDS, CloudWatch, Slack API.<br/>
...
**Task performed to complete the project:** <br/> **1. Set Up Amazon RDS Instance** - Create an Amazon RDS instance (e.g., PostgreSQL or MySQL). Configure the instance's security group to allow connections from AWS Lambda.<br/>
...
**5. Send Alerts to Slack** - Use the Slack API to send alerts when the API server goes down. <br/>
